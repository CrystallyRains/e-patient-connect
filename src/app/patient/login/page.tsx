    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Patient Login</h1>
          <p className="text-gray-700 mt-2">Access your medical records securely</p>
        </div>
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-gray-800 mb-3">Choose Authentication Method</label>
        ...
        {authMethod === 'BIOMETRIC' && (
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-800 mb-3">Select Biometric Type</label>
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
        ...
        <div className="mt-6 text-center">
          <Link href="/patient/register" className="text-blue-600 hover:text-blue-800 font-medium">
